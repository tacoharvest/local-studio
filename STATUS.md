...
- [x] Inspect remaining agent browser and workspace navigation effect modules.
- [x] Replace agent browser and workspace URL navigation effects with `useSyncExternalStore`.
