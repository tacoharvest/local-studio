...
- [x] Inspect logs lifecycle hooks.
- [x] Replace log session loading, selected log loading, SSE log streaming, and auto-scroll with `useSyncExternalStore`.
