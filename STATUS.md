...
- [x] Inspect decorative controller definition dividers.
- [x] Remove redundant decorative controller definition dividers.
- [x] Validate decorative divider cleanup slice.
- [x] Commit this slice.
