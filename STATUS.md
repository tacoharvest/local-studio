...
- [x] Inspect runtime target route coverage gaps.
- [x] Add deterministic integration coverage for configured llama.cpp target lookup, health, selection, persisted active state, and observability rows.
