...
- [x] Inspect monitoring/log operational process lookup boundaries.
- [x] Instrument `/logs` process lookup with persistent function-call tracking.
- [x] Add integration coverage proving log lookup rows are recorded.
