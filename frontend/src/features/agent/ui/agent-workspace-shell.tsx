...
import { useAgentWorkspaceNavigationEffects } from "@/features/agent/hooks/use-agent-workspace-navigation-effects";
import { useActiveCanvasSessionEffects } from "@/features/agent/hooks/use-active-canvas-session-effects";
