...
export function QuickProjectPicker({ projects }: Props) {
  ...
  return (
    ...
    >
      ...
      {open ? (
        <div className="absolute bottom-full left-0 z-[80] mb-1 max-h-[280px] w-[220px] overflow-y-auto rounded-md border border-(--border) bg-[#151515] p-1 shadow-[0_12px_36px_rgba(0,0,0,0.65)]">
